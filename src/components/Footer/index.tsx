...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-gradient-to-b from-white to-champagne-light">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5 hover:text-gold transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 text-gray-600 hover:text-gold"
              >
                <svg
              ...
              <a
                ...
                className="flex ease-out duration-200 hover:text-gold"
              >
                <svg
                  className="fill-current"
                  width="20"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-gold" href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-gradient-to-r from-gold to-gold-dark ease-out duration-200 hover:from-gold-dark hover:to-gold"
                  href="#"
                >
                  <svg
                    className="fill-current"
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-champagne border-t border-gold-light-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
