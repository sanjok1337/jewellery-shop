...
const OrderModal = ({ showDetails, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className="shadow-7 relative w-full max-w-[600px] min-h-[242px] scale-100 transform rounded-[15px] bg-white transition-all flex flex-col justify-center items-center p-6">
          <button
