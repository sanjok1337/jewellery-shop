  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-white transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow-lg border-b border-gold-light-3"
      }`}
    >
        ...
        >
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <span className="block text-2xs text-gray-500 uppercase tracking-wide">
                  24/7 SUPPORT
                </span>
              ...
              <div className="flex items-center gap-5">
                {isAuthenticated && user ? (
                  <div className="relative group">
                    ...
                    {/* Dropdown Menu */}
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-xl border border-gold-light-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                      <div className="py-2">
                        <Link
                          href="/my-account"
                          className="block px-4 py-2 text-sm text-dark hover:bg-champagne-light hover:text-gold-dark transition-colors"
                        >
                          My Account
                        </Link>
                        <Link
                        ...
                        <hr className="my-2 border-gold-light-3" />
                        <button
                          onClick={logout}
                          className="w-full text-left px-4 py-2 text-sm text-rose hover:bg-rose-light transition-colors"
                        >
                          Logout
                        </button>
                      </div>
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-gradient-to-r from-gold to-gold-dark w-4.5 h-4.5 rounded-full text-white">
                      {cartItemsCount}
                    </span>
                  </span>
      ...
      <div className="border-t border-gold-light-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            ...
            <div
              className={`w-[288px] absolute right-4 top-full xl:static xl:w-auto h-0 xl:h-auto invisible xl:visible xl:flex items-center justify-between ${
                navigationOpen &&
                `!visible bg-white shadow-xl border border-gold-light-3 !h-auto max-h-[400px] overflow-y-scroll rounded-xl p-5`
              }`}
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-gradient-to-r before:from-gold before:to-gold-dark before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-gold text-custom-sm font-medium text-dark flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-gold transition-colors"
                  >
                    <svg
                ...
                <li className="py-4">
                  ...
                  >
                    <div className="relative">
                      ...
                      {wishlistCount > 0 && (
                        <span className="absolute -top-3 -right-2 text-xs font-semibold text-dark">
                          {wishlistCount}
                        </span>
                      )}
                    </div>
