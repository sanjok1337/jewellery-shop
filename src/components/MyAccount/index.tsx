              ...
              <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-4">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  <div className="max-w-[64px] w-full h-16 rounded-full overflow-hidden">
                    <Image
                      src={user?.avatar_url || "/images/users/user-04.jpg"}
                      alt="user"
                      width={64}
                      height={64}
                    />
                  ...
                  {loading ? (
                    ...
                    <div className="flex flex-col gap-4">
                      {addresses.map((address, index) => (
                        <div key={address.id} className={`${index < addresses.length - 1 ? 'border-b pb-4' : ''}`}>
                          <p className="flex gap-2.5 text-custom-sm">
                            <svg
                              className="fill-current mt-0.5 flex-shrink-0"
                              width="18"
                              height="18"
                              viewBox="0 0 18 18"
                              fill="none"
                ...
                <form onSubmit={handleChangeEmail}>
                  <div className="mb-5">
                    ...
                    <input
                      ...
                      value={user?.email || ''}
                      disabled
                      className="rounded-md border border-gray-3 bg-gray-2 text-dark-4 w-full py-2.5 px-5 outline-none"
                    />
                  </div>
                ...
                <form onSubmit={handleChangePassword}>
                  <div className="mb-5">
                    ...
                    {passwordErrors.oldPassword && (
                      <p className="text-red text-sm mt-1">{passwordErrors.oldPassword}</p>
                    )}
                  </div>
                  ...
                  <div className="mb-5">
                    ...
                    {passwordErrors.confirmNewPassword && (
                      <p className="text-red text-sm mt-1">{passwordErrors.confirmNewPassword}</p>
                    )}
                  </div>
